...
feature1 = st.slider("Feature 1", value=0.74)
feature2 = st.slider("Feature 2", value=0.595)
feature3 = st.slider("Feature 3", value=0.19)
feature4 = st.slider("Feature 4", value=2.3235)
feature5 = st.slider("Feature 5", value=1.1495)
feature6 = st.slider("Feature 6", value=0.5115)
feature7 = st.slider("Feature 7", value=0.505)
feature8 = st.slider("Feature 8", value=11.0)
